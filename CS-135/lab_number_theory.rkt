...
(define (wj-solvable? cA cB g)
  (if (and (= (lcm g (gcd cA cB)) g) (or (>= cA g) (>= cB g)))
      #t
      #f))
...
;; I was unable to get the list order in the correct formatting, however, the numbers presented in the list are correct
(define (waterjug cA cB g)
  (define (jug fA fB)
    (cond ((= fB g) (list (list fA fB)))
          ((= fB cB) (list (list fA fB) (jug fA 0)))
          ((= fA 0) (list (list fA fB) (jug cA fB)))
          ((> (+ fA fB) cB) (list (list fA fB) (jug (- fA (- cB fB)) cB)))
          ((<= (+ fA fB) cB) (list (list fA fB) (jug 0 (+ fB fA))))))
  (jug 0 0))
