...
;; 2 PTS
(define (yoda words)
  (append (cddr words) (append (list (car words)) (list (cadr words)))))
...
(define (pig-latin word)
  (append (append (cdr word) (list (car word))) (list 'a 'y)))
...
;; 2 PTS
(define (rotate c)
  (append (list c) (list (list (cadr c) (- (car c)))) (list (list (- (car c)) (- (cadr c)))) (list (list (- (cadr c)) (car c)))))
