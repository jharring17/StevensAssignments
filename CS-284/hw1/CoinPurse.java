...
public class CoinPurse {
	...
	public CoinPurse(int g, int s, int k) {
		...
		if (g + s + k > CAPACITY) {
			...
			throw new IllegalArgumentException("Coin number cannot be less than zero.");
		}
	}
	...
	public void depositGalleons(int n) {
		...
		if (numGalleons + numSickles + numKnuts > CAPACITY) {
			...
			throw new IllegalArgumentException("Coin amounts cannot be less than zero.");
		}
	}
	...
	public String toString() {
		return ("\nNumber of Galleons: " + numGalleons + "\nNumber of Sickles: " + numSickles + "\nNumber of Knuts: "
				+ numKnuts);
	}
	...
	// Draws random coin from CoinPurse
	public int drawRandCoin() {
		...
		if (numCoins() == 0) {
			throw new IllegalArgumentException("No coins in the CoinPurse.");
		} else if (res < k) {
			return 0;
	...
	// Draws sequence of random coins
	...
	// Compare coin sequences and keeps the higher number
