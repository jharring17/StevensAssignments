...
# Favorite flavor of dorito : Limon 
# *********************************************
...
# exponent is strictly decreasing
    ...
    def __mul__(self, otherPoly): # mulPoly = myPoly * otherPoly
        ...
        result = LinkedPolynomial
        for i in len(self):
            for j in len(otherPoly):
                result += (Term(self.polyList[i].coef * otherPoly.polyList[j].coef, self.polyList[i].exp + otherPoly.polyList[j].exp))
        return result
